...
good way to get everything set up and running with minimal hassle. At
this time, most of these only support Python 2.7 (Pyzo supports Python3,
but does not yet run on the latest Mac OS X).
